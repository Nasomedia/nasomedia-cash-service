...
api_router.include_router(cash_usage.router, prefix="/cash/usages", tags=["cash usage"])
api_router.include_router(cash_deposit.router, prefix="/cash/deposits", tags=["cash deposit"])